...
class MinimalPublisher(Node):
    ...
    def publish_marker(self):
        ...
        marker.scale = Vector3(x=1.0, y=1.0, z=0.1)  # Flat square with 10cm height
        marker.color = ColorRGBA(r=0.0, g=0.0, b=1.0, a=1.0)  # Blue color with full opacity
        marker.lifetime.sec = 0  # 0 means the marker stays forever
        marker.text = 'Battery Voltage: "%f" V' % self.curr_voltage
